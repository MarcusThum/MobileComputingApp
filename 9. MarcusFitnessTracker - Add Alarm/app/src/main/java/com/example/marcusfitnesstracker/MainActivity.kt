...
import com.example.marcusfitnesstracker.data.SleepPatternViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    private val sleepViewModel: SleepPatternViewModel by viewModel()
            ...
            if(!isLoading) {
                if (!startSetup) {
                    ...
                    if (!setupCompleted) {
                        ...
                        mealViewModel.loadMeals { loadedMeals ->
                            var loadedMeals = loadedMeals
                            // Update your UI here, e.g., notify RecyclerView
